...
def variantDir = '/pl/active/dashnowlab/projects/TR-benchmarking/benchmark-full-catalog-tr-explorer-HG/'
...
process strdust {
    ...
    script:
    def strdust_tr_regions = '/pl/active/dashnowlab/projects/TR-benchmarking/catalogs/tr_explorer_catalog/TR_catalog_for_STRdust.bed'
...
process vamos {
    ...
    script:
    def vamos_tr_regions = '/pl/active/dashnowlab/projects/TR-benchmarking/catalogs/TR_catalog_for_vamos.bed'
